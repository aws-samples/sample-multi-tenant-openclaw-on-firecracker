...
# T3-4 Phase 2: pure, stateless helpers + their constants now live in
# domains.common. Re-exported here so `api.<name>` keeps resolving for the test
# suite and intra-handler callers (the routes/RBAC/handlers reference these).
from domains.common import (  # noqa: F401
    _NAME_RE,
    _SCHED_DAYS,
    _TAG_MAX_COUNT,
    _TAG_MAX_KEY_LEN,
    _TAG_MAX_VALUE_LEN,
    _TTL_MAX_HOURS,
    _TTL_VALID_ON_EXPIRY,
    _collect_tag_filters,
    _gen_id,
    _matches_all_tags,
    _now,
    _parse_schedule,
...
# Issue #48 tracks the rationale. The pure validators / parsers that used to
# live here (TTL #28, schedule #30, tag helpers #10, name validation) moved to
# domains.common in T3-4 Phase 2 and are re-exported at the top of this module.
# ═══════════════════════════════════════════════════════════════════════════

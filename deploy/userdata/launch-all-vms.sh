...
#      is <3800B and contains JSON-lines: {"t":"...","n":42,"c":2,"m":2048,"e":0}
...
_launch_one() {
  ...
  # 10 positional args mirror the launch-vm.sh signature so chat_ep lands at $10.
  # Empty strings for positions 5-9 keep launch-vm's backward-compat defaults
  # (secrets are pulled from DDB by launch-vm itself in the shared path).
...
_dispatch_line() {
  # Parse ONE JSON-line: {"t":"t-xxx","n":42,"c":2,"m":2048,"e":0}
  ...
  local tid vm_num vcpu mem_mb chat_ep

...
ENABLE_PER_TENANT_ALB_RULE = _clients.ENABLE_PER_TENANT_ALB_RULE
...
# T1.6 — core/legacy_alb:旧架构 per-tenant ALB target-group/rule 管理(7 函数)。
from core import legacy_alb as _legacy_alb  # noqa: E402

_get_listener_arn = _legacy_alb._get_listener_arn
_ensure_host_tg = _legacy_alb._ensure_host_tg
_add_alb_rule = _legacy_alb._add_alb_rule
_add_alb_rule_impl = _legacy_alb._add_alb_rule_impl
_repoint_alb_rule_to_tg = _legacy_alb._repoint_alb_rule_to_tg
_remove_alb_rule = _legacy_alb._remove_alb_rule
_remove_host_tg = _legacy_alb._remove_host_tg
...
# T1.1 — core/auth:身份验证 / RBAC / IDOR 所有权 / Cognito 渠道机器用户(16 函数)。
...
_provision_channel_machine_user = _auth._provision_channel_machine_user
_delete_channel_machine_user = _auth._delete_channel_machine_user
_cognito_creds_from_tenant = _auth._cognito_creds_from_tenant
_guest_ip = _auth._guest_ip
_emit_create_latency = _auth._emit_create_latency
_cognito_idp_client = _auth._cognito_idp_client
